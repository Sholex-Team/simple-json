...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/sholex-team/simple-json/cmake.yml?logo=GitHub)](https://github.com/Sholex-Team/simple-json/actions/workflows/cmake.yml)
...
3. Link the shared library to your project
   ```cmake
   find_package(simple-json 0.3.1 REQUIRED)
...
2. Install the binary using a package manager
   ```sh
   sudo dpkg -i simple-json-0.3.1.deb
   ```
3. Link the shared library to your project
   ```cmake
   find_package(simple-json 0.3.1 REQUIRED)
