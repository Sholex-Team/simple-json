...
namespace simple_json::iterators {
    ...
    public:
         ...
         */
        [[nodiscard]] explicit BaseJsonIterator(IteratorTypes used_type);
         ...
         */
        [[nodiscard]] BaseJsonIterator(const BaseJsonIterator & base_json_iterator) = default;
