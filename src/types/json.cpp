...
namespace simple_json::types {
    ...
    Json::iterator & Json::iterator::operator=(const Json::iterator & r_iterator) {
        if (used_type == IteratorTypes::array_iterator_type)
            array_iterator = new Array::iterator {* r_iterator.array_iterator};
        else
            json_object_iterator = new JsonObject::iterator {* r_iterator.json_object_iterator};
    ...
    Json::iterator & Json::iterator::operator=(Json::iterator && r_iterator)  noexcept {
        if (used_type == IteratorTypes::array_iterator_type) {
            array_iterator = r_iterator.array_iterator;
            r_iterator.array_iterator = nullptr;
        } else {
    ...
    Json::const_iterator & Json::const_iterator::operator=(const Json::const_iterator & r_iterator) {
        if (used_type == IteratorTypes::array_iterator_type)
            array_iterator = new Array::const_iterator {* r_iterator.array_iterator};
        else
            json_object_iterator = new JsonObject::const_iterator {* r_iterator.json_object_iterator};
    ...
    Json::const_iterator & Json::const_iterator::operator=(Json::const_iterator && r_iterator)  noexcept {
        if (used_type == IteratorTypes::array_iterator_type) {
            array_iterator = r_iterator.array_iterator;
            r_iterator.array_iterator = nullptr;
        } else {
    ...
    Json::const_reverse_iterator & Json::const_reverse_iterator::operator=(const Json::const_reverse_iterator & r_iterator) {
        if (used_type == IteratorTypes::array_iterator_type)
            array_iterator = new Array::const_reverse_iterator {* r_iterator.array_iterator};
        else
            json_object_iterator = new JsonObject::const_reverse_iterator {* r_iterator.json_object_iterator};
    ...
    Json::const_reverse_iterator & Json::const_reverse_iterator::operator=(Json::const_reverse_iterator && r_iterator)  noexcept {
        if (used_type == IteratorTypes::array_iterator_type) {
            array_iterator = r_iterator.array_iterator;
            r_iterator.array_iterator = nullptr;
        } else {
